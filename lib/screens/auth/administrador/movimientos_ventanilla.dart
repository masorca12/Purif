// movimientos_ventanilla.dart
import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';

class MovimientosVentanillaPage extends StatefulWidget {
  final String empresaCodigo;
  const MovimientosVentanillaPage({Key? key, required this.empresaCodigo}) : super(key: key);

  @override
  State<MovimientosVentanillaPage> createState() => _MovimientosVentanillaPageState();
}

class _MovimientosVentanillaPageState extends State<MovimientosVentanillaPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Movimientos - Ventanilla'),
      ),
      body: Column(
        children: [
          Padding(
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              stream: movimientosRef().where('ventanilla', isEqualTo: true).orderBy('fecha', descending: true).snapshots(),
